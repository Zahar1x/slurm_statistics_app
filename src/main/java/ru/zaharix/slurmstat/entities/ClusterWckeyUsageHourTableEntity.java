...
@Entity
@Table(name = "cluster_wckey_usage_hour_table", schema = "slurm_acct_db", catalog = "")
@IdClass(ClusterWckeyUsageHourTableEntityPK.class)
public class ClusterWckeyUsageHourTableEntity {
    @Basic
    ...
    public boolean equals(Object o) {
        ...
        ClusterWckeyUsageHourTableEntity that = (ClusterWckeyUsageHourTableEntity) o;
