...
public class ClusterWckeyUsageMonthTableEntityPK implements Serializable {
    @Column(name = "id")
    @Id
    ...
    public boolean equals(Object o) {
        ...
        ClusterWckeyUsageMonthTableEntityPK that = (ClusterWckeyUsageMonthTableEntityPK) o;
