...
@Entity
@Table(name = "cluster_usage_month_table", schema = "slurm_acct_db", catalog = "")
@IdClass(ClusterUsageMonthTableEntityPK.class)
public class ClusterUsageMonthTableEntity {
    @Basic
    ...
    public boolean equals(Object o) {
        ...
        ClusterUsageMonthTableEntity that = (ClusterUsageMonthTableEntity) o;
