...
@Entity
@Table(name = "cluster_assoc_usage_month_table", schema = "slurm_acct_db", catalog = "")
@IdClass(ClusterAssocUsageMonthTableEntityPK.class)
public class ClusterAssocUsageMonthTableEntity {
    @Basic
    ...
    public boolean equals(Object o) {
        ...
        ClusterAssocUsageMonthTableEntity that = (ClusterAssocUsageMonthTableEntity) o;
