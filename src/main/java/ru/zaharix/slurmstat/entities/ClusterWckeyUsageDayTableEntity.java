...
@Entity
@Table(name = "cluster_wckey_usage_day_table", schema = "slurm_acct_db", catalog = "")
@IdClass(ClusterWckeyUsageDayTableEntityPK.class)
public class ClusterWckeyUsageDayTableEntity {
    @Basic
    ...
    public boolean equals(Object o) {
        ...
        ClusterWckeyUsageDayTableEntity that = (ClusterWckeyUsageDayTableEntity) o;
