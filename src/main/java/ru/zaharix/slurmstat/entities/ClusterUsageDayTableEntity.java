...
@Entity
@Table(name = "cluster_usage_day_table", schema = "slurm_acct_db", catalog = "")
@IdClass(ClusterUsageDayTableEntityPK.class)
public class ClusterUsageDayTableEntity {
    @Basic
    ...
    public boolean equals(Object o) {
        ...
        ClusterUsageDayTableEntity that = (ClusterUsageDayTableEntity) o;
