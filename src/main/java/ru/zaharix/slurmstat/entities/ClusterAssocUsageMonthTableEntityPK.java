...
public class ClusterAssocUsageMonthTableEntityPK implements Serializable {
    @Column(name = "id")
    @Id
    ...
    public boolean equals(Object o) {
        ...
        ClusterAssocUsageMonthTableEntityPK that = (ClusterAssocUsageMonthTableEntityPK) o;
