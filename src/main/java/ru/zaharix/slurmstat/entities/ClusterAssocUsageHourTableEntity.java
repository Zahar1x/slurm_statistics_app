...
@Entity
@Table(name = "cluster_assoc_usage_hour_table", schema = "slurm_acct_db", catalog = "")
@IdClass(ClusterAssocUsageHourTableEntityPK.class)
public class ClusterAssocUsageHourTableEntity {
    @Basic
    ...
    public boolean equals(Object o) {
        ...
        ClusterAssocUsageHourTableEntity that = (ClusterAssocUsageHourTableEntity) o;
