...
@Entity
@Table(name = "cluster_wckey_usage_month_table", schema = "slurm_acct_db", catalog = "")
@IdClass(ClusterWckeyUsageMonthTableEntityPK.class)
public class ClusterWckeyUsageMonthTableEntity {
    @Basic
    ...
    public boolean equals(Object o) {
        ...
        ClusterWckeyUsageMonthTableEntity that = (ClusterWckeyUsageMonthTableEntity) o;
